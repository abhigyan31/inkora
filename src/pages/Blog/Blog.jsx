...
function Blog() {
  ...
  /* Re-reads whenever a blog is published, edited or deleted. */
  const [storedBlogs] = useStore(KEYS.blogs, []);
  ...
  function handleComment() {
    ...
    addComment(blog, value, replyTo?.id || null);
          ...
          <div className="mt-8 flex flex-wrap items-center justify-between gap-5 border-y border-neutral-200 py-5 dark:border-neutral-800">
            ...
            <div className="flex items-center gap-2">
              {isOwnBlog ? (
                ...
                <button
                  type="button"
                  onClick={() => toggleFollow(authorUsername, { name: authorName })}
                ...
                {topLevelComments
                  ...
                  .map((comment) => (
                    <Comment
                      ...
                      onReply={setReplyTo}
                      onDelete={(commentId) =>
                        deleteComment(blog.id, commentId)
                      }
                    />
                  ))}
              </div>
