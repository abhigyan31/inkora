...
function Auth() {
  ...
  function handleGoogleLogin() {
    setNotice(
      "Google sign-in needs a real backend to verify the token, so it is " +
        "not available while INKORA runs entirely in the browser. Use an " +
                ...
                <div className="mb-2 flex items-center justify-between">
                  ...
                  {!isSignup && (
                    <button
                      ...
                      onClick={() =>
                        setNotice(
                          "Password reset needs a server to send the email, " +
                            "so it arrives with the backend. Accounts here " +
