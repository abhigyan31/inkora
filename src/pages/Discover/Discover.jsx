...
function Discover() {
  ...
  /* Demo blogs AND everything published from Create. */
  ...
  const filteredWriters = useMemo(() => {
    ...
    const matches = writers.filter((writer) =>
      `${writer.name} ${writer.username} ${writer.category}`
        .toLowerCase()
        .includes(searchValue)
    );

    return matches.length > 0 ? matches : writers.slice(0, 4);
  }, [search]);
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="truncate text-[10px] text-neutral-400">
                          {writer.username} · {writer.followers}
                        </p>
